...
![image-20221111095903264](并行计算-hw3/image-20221111095903264.webp)
...
![image-20221111105308194](并行计算-hw3/image-20221111105308194.webp)
...
![image-20221111110216387](并行计算-hw3/image-20221111110216387.webp)
...
![image-20221111114901745](并行计算-hw3/image-20221111114901745.webp)
...
![image-20221111121317893](并行计算-hw3/image-20221111121317893.webp)

![image-20221111121333805](并行计算-hw3/image-20221111121333805.webp)

在并行矩阵乘法中，我们利用 `MPI_Scatter` 进行对矩阵 $A$ 进行**块状（block）划分**，如图所示：

![](并行计算-hw3/scatter.drawio.webp)
