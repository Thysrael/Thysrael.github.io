...
- store 中包含两个存储对象，一是注册时基本信息的存储，在注册密码页发送请求时一起调用；二是用户 token。
...
* **app**
  ...
  * **util.py**
  ...
  该文件定义了一些工具函数，用于处理一些常用的操作，如密码加密、token 生成等。
...
vue 中，文件上传需要以 FormData 的结构发送给后端。即
...
<img src="DBMS-实现报告/image-20221221135549266.webp" alt="image-20221221135549266" style="zoom:67%;" />
...
<img src="DBMS-实现报告/image-20221221231316744.webp" alt="image-20221221231316744" style="zoom:80%;" />
...
<img src="DBMS-实现报告/image-20221221232351946.webp" alt="image-20221221232351946"  />
...
![image-20221221232558406](DBMS-实现报告/image-20221221232558406.webp)
...
![image-20221221232758214](DBMS-实现报告/image-20221221232758214.webp)

学生注册界面：

![image-20221221233317411](DBMS-实现报告/image-20221221233317411.webp)
...
![image-20221221233457074](DBMS-实现报告/image-20221221233457074.webp)
...
![image-20221221234005472](DBMS-实现报告/image-20221221234005472.webp)
...
![image-20221222001923805](DBMS-实现报告/image-20221222001923805.webp)
...
![image-20221222002346692](DBMS-实现报告/image-20221222002346692.webp)

**提交作业**

![image-20221222002421520](DBMS-实现报告/image-20221222002421520.webp)
...
![image-20221221234427928](DBMS-实现报告/image-20221221234427928.webp)
...
![image-20221221234648414](DBMS-实现报告/image-20221221234648414.webp)

**添加活动**：

![image-20221221234724546](DBMS-实现报告/image-20221221234724546.webp)
...
![image-20221221235603410](DBMS-实现报告/image-20221221235603410.webp)

**筛选机制**

![image-20221221235714354](DBMS-实现报告/image-20221221235714354.webp)

**推荐机制**

![image-20221221235843792](DBMS-实现报告/image-20221221235843792.webp)
...
![image-20221222000308893](DBMS-实现报告/image-20221222000308893.webp)
...
![image-20221222000728709](DBMS-实现报告/image-20221222000728709.webp)

**相似活动推荐**

![image-20221222000843237](DBMS-实现报告/image-20221222000843237.webp)
...
![image-20221222002901744](DBMS-实现报告/image-20221222002901744.webp)
...
![image-20221222003213771](DBMS-实现报告/image-20221222003213771.webp)
...
![image-20221222003550614](DBMS-实现报告/image-20221222003550614.webp)

**排行榜**

![image-20221222003608127](DBMS-实现报告/image-20221222003608127.webp)
...
![image-20221222001339919](DBMS-实现报告/image-20221222001339919.webp)
...
![image-20221222001656642](DBMS-实现报告/image-20221222001656642.webp)
...
现在时间是 2022 年 12 月 20 日，如果从 9 月份项目立项开始算起，Go 走马已经是一个 4 个月大的宝宝了。这四个月里，我们仨人每周开一次组会，不定期的在群里讨论问题，互相吸取长处，一起解决困难，有了十足的进步。
...
![image-20230105122315380](DBMS-实现报告/image-20230105122315380.webp)
