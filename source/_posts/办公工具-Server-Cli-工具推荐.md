...
![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219662.(null))

但是最重要的一点是，shell prompt 应该是双行设置，不然很容易出现信息挤压的情况。

单行：

![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219712.(null))

双行

![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219704.(null))
...
![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219816.(null))

### 3.4 Bat：彩色的 Cat

提供代码高亮的 cat

![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214220446.(null))
...
![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219715.(null))
...
![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219789.(null))

另一种是路径非常复杂，导致我们没法快速敲出来（我们设置都不能快速记住）

![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219870.(null))

### 4.3 Zsh-AutoSuggestion：Zsh 命令的自动补全

这个功能非常常见了，是 zsh 的插件，用于提示可能的历史命令：

![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214219860.(null))
...
![img](./办公工具-Server-Cli-工具推荐/(null)-20260120214220014.(null))
