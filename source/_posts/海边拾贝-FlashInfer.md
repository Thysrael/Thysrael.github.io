...
![img](./海边拾贝-FlashInfer/1746537571691-1.webp)

放到 roofline 上来看

![img](./海边拾贝-FlashInfer/1746537571691-2.webp)

动态变化的 Queries 长度就对 Attention 的动态性提出了一定的要求。

此外优化长文本有一种经典的技术就是 KV Cache 稀疏，也就是 KV Cache 也会存在变化（不止是单调递增），如 NSA 就包含三种稀疏特性：

![img](./海边拾贝-FlashInfer/1746537571691-3.webp)
...
![img](./海边拾贝-FlashInfer/1746537641901-14.webp)

和 attention output：

![img](./海边拾贝-FlashInfer/1746537641901-15.webp)

有了这两个东西以后，我们就可以将 block $\mathcal{I}$ 和 block $\mathcal{J}$ 融合到一起了：

![img](./海边拾贝-FlashInfer/1746537641902-16.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-17.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-18.webp)

其中虚线的部分组成了一个 block，说明 Page1 是被 Proc0 和 Proc1 共享的。

然后我们迁移到 PI 上，将 Proc 换成 Query Chunk，将 Page 换成 KV Cache Chunk，有：

![img](./海边拾贝-FlashInfer/1746537641902-19.webp)

直接用论文中的图来看：

![img](./海边拾贝-FlashInfer/1746537641902-20.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-21.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-22.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-23.webp)
...
![img](./海边拾贝-FlashInfer/1746537641902-24.webp)

### 3.2 Kernel 测试

与 FA2&3 进行对比，主要测试的是针对 Query 的动态特性，能不能有及时的反应：

![img](./海边拾贝-FlashInfer/1746537641902-25.webp)
