...
![image-20240217112245601](硬件平台-ARM虚拟与安全/image-20240217112245601.webp)

Type1（类型 1）Hypervisor 也叫 native 或 bare-metal Hypervisor。这类虚拟化层直接运行在硬件之上，没有所谓的宿主机操作系统。它们直接控制硬件资源以及客户机。典型地如 Xen 和 VMware ESX。

Type2（类型 2）Hypervisor 运行在一个宿主机操作系统之上，也就是一个应用程序，如 VMware Workstation；或宿主操作系统里，也就是内核的一部分，如 KVM。
...
![image-20240217113903538](硬件平台-ARM虚拟与安全/image-20240217113903538.webp)
...
![image-20240217115357500](硬件平台-ARM虚拟与安全/image-20240217115357500.webp)
...
![image-20240217120937767](硬件平台-ARM虚拟与安全/image-20240217120937767.webp)
