...
![image-20220307081120711](操作系统-BASH/image-20220307081120711.webp)

具体呈现的就是这样的结构：

![image-20220307082853471](操作系统-BASH/image-20220307082853471.webp)

所谓的全局变量，就是只能在当前进程中起作用。比如下面的例子：

![image-20220307084143247](操作系统-BASH/image-20220307084143247.webp)
...
![image-20220307084755842](操作系统-BASH/image-20220307084755842.webp)
...
![image-20220307093309080](操作系统-BASH/image-20220307093309080.webp)
...
![image-20220307120559869](操作系统-BASH/image-20220307120559869.webp)
...
![image-20220307140643399](操作系统-BASH/image-20220307140643399.webp)

### 2.6 整数计算

因为变量的默认形式都是字符串，所以对于这种代码，会有很不尽如人意的输出

![image-20220310114444770](操作系统-BASH/image-20220310114444770.webp)

所以需要采用特定的写法，如下

![image-20220310114650199](操作系统-BASH/image-20220310114650199.webp)

还有用命令写的：

![image-20220310114925610](操作系统-BASH/image-20220310114925610.webp)
...
![fcffb46f5ef30a4cbc7594c4e70c8fa](操作系统-BASH/fcffb46f5ef30a4cbc7594c4e70c8fa.webp)
...
![image-20220307145749868](操作系统-BASH/image-20220307145749868.webp)

如果接着运行其他重定向命令，那么就会有如下结果：

![image-20220307145925758](操作系统-BASH/image-20220307145925758.webp)
...
![image-20220307150156975](操作系统-BASH/image-20220307150156975.webp)
...
![c2959dbe9c5569f358ab936d4fde5ac](操作系统-BASH/c2959dbe9c5569f358ab936d4fde5ac.webp)
...
![image-20220307165911049](操作系统-BASH/image-20220307165911049.webp)
...
![image-20220307171215733](操作系统-BASH/image-20220307171215733.webp)

可以看到，我把我的博客的 generate 的输出信息输入到了 `less` 中，这样我就可以用 `less` 来查看我的产生信息了。 

![image-20220307171149608](操作系统-BASH/image-20220307171149608.webp)
...
![image-20220307172035395](操作系统-BASH/image-20220307172035395.webp)
...
![image-20220307172232162](操作系统-BASH/image-20220307172232162.webp)
...
![image-20220307172729116](操作系统-BASH/image-20220307172729116.webp)
...
![image-20220316222141383](操作系统-BASH/image-20220316222141383.webp)
...
![image-20220316223312879](操作系统-BASH/image-20220316223312879.webp)
...
![image-20220316224039583](操作系统-BASH/image-20220316224039583.webp)

![image-20220316224300520](操作系统-BASH/image-20220316224300520.webp)

![image-20220316224440805](操作系统-BASH/image-20220316224440805.webp)
...
![image-20220317104843806](操作系统-BASH/image-20220317104843806.webp)
...
![image-20220307174838762](操作系统-BASH/image-20220307174838762.webp)
...
![image-20220307224930981](操作系统-BASH/image-20220307224930981.webp)
