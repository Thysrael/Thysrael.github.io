...
万维网就是一个 “把所有人连接” 起来的网络，他和上面讲的 “文章网络” 本质是一样的。不过当规模大了以后，新的问题就会产生。网络传输的规则应当是同一个（类似于车同轨，书同文），这就衍生了各种网络传输协议。网络是包容的，所以网络传输的内容就必须可以以一种让所有人都理解的方式显示，这就衍生了浏览器的渲染。网络是庞大的，所以就需要有索引来定位各个网络节点和资源，这就衍生了 IP 地址、域名、URL。
...
![image-20221014201655838](DBMS-Web开发直观/image-20221014201655838.webp)
