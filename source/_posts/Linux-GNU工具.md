...
![image-20230920163008838](Linux-GNU工具/image-20230920163008838.webp)
...
![image-20230921090246054](Linux-GNU工具/image-20230921090246054.webp)
...
awk 不只是是一个简单的工具，他更是一种语言，这种语言对于处理 “字符串数据库” 很适合，因为它内置了许多变量用于描述 record 和 record 多个字段，同时对于字符串和数的处理很简便。很多人都会说 awk 的语法很像（是真的很像，基本上所有语法细节都是一样的），我认为 awk 是一种特化的 C。
